...
Products should not only be usable but also useful. This means they satisfy an existing need of the people using them. To be able to create such products, you need to find out about motivations, activities and problems of the (potential) product’s users.
...
<!--V2:   
Initially, I found it hard to learn about methods to research user needs. The academic books were often largely about theory and seemed distant from the problems I had. The books written by practicioners often assumed a large team and budget – many beginners have neither of them.  So I started to gather articles that helped me, talked to other researchers and documented and refined the methods I applied. In this book I want to show you how to use these methods.  -->

<!-- V1: 
I found it hard to learn about methods to find out more about the users’ needs:  Some books started with a lot of theory that was build on additional theories. Other resources were more design oriented, but seemed to require a big team of well-trained people and a huge budget. However, there were also great resources, blog posts and conversations that helped me learn about user research and use it for my projects.
-->
 
In this book, I want to show methods to research user needs. I try to keep the barrier low with methods which…

* … are  useful for design projects in business and academia
* … work without a large budget
* … are  understandable and applicable without a specific (academic) background

I provide examples to make learning easier. Much more useful than a definition of principles like *asking open questions* or *clustering themes* is to see how these principles are put into action.
